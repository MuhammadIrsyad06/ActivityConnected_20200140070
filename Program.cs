...
namespace Connected
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using(SqlConnection cn = new SqlConnection(connectionString))
            {
                ...
                using(SqlDataReader dr1 = cmd1.ExecuteReader()){
                    while (dr1.Read())
                    {
                        string query2 = "UPDATE Pembimbing_Akademik SET Keahilan='Jaringan' WHERE NIK=333";
        ...
        {
            return "data source= MUHAMMAD-IRSYAD;database=ProdiTI;MultipleActiveResultSets=True;" +
                "User ID=sa;Password=06092002";
        }
    }
